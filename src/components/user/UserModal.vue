<template>
    <div class="w-[81.5%] h-[18.5%] z-20 absolute">
        ...
        <dialog id="myModal" class="bg-white rounded-md-[60%] h-[80%]">
            ...
            <div class="flex w-full h-auto py-10 px-2 justify-center items-center bg-white rounded text-center text-black">
                <form class="flex flex-col w-full mt-1" @submit="onSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <Field type="number" id="user" name="age" placeholder="Edad" class="mt-2 p-2 block w-full rounded-md bg-white border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"/>
                        ...
                        <!--Buttons-->
                        <br>
                        <div class="flex justify-center space-x4">
