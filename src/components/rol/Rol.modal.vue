<template>
    <div class="z-0 absolute w-[81.5%] h-[calc(100% - 20%)]  left-[18.5%] top-[8.7%] flex  justify-center bg-white">
        <button @click="showModal = true"
            class="flex items-center text-white font-bold py-2 px-4 rounded-full shadow-md" :style="{
        ...
        <div v-show="showModal" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <form @submit="onSubmit">
                    <div class="mb-4">
                        <label for="rol" class="block text-black  text-sm font-bold mb-1">Rol</label>
                        <Field name="rol" as="input" type="text" class="w-full h-10 p-4 border rounded-xl text-black placeholder-black::placeholder"
